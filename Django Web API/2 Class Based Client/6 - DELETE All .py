...
class DeleteAllEmployeesView(View):
    template_name = 'master/delete_result.html'
...
from .views import DeleteAllEmployeesView

urlpatterns = [
    path('delete/', DeleteAllEmployeesView.as_view(), name='delete_employees_view'),
]
