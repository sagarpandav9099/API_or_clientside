...
class TeacherViewSet(viewsets.ModelViewSet):
    """
    A viewset for viewing and editing teacher instances, with filtering and searching.
    """
    queryset = Teacher.objects.all()
    serializer_class = TeacherSerializer
    filter_backends = [DjangoFilterBackend, filters.SearchFilter, filters.OrderingFilter]
    filterset_fields = ['subject', 'city']  # Fields for filtering
    search_fields = ['first_name', 'last_name', 'subject', 'city']  # Fields for searching
    ordering_fields = ['first_name', 'last_name', 'subject', 'city']  # Fields for ordering
