...
def update_employee_view(request, employee_id):
    if request.method == 'POST':
        ...
        form = EmployeeForm()
    return render(request, 'master/update_employee.html', {'form': form, 'employee_id': employee_id})
...
from .views import update_employee_view

urlpatterns = [
    path('employees/update/<int:employee_id>/', update_employee_view, name='update_employee_view'),
]
...
URL: http://127.0.0.1:9000/master/employees/update/1/