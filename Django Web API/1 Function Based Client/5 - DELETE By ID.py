...
def delete_employee_view(request):
    if request.method == 'POST':
        ...
        form = EmployeeForm()
    return render(request, 'master/delete_employee_form.html', {'form': form})
...
from .views import delete_employee_view

urlpatterns = [
    path('delete/', delete_employee_view, name='delete_employee_view'),
]
